...
@NoArgsConstructor
@Entity
@Table(name = "power_playlist_scheduler")
public class PowerPlaylistScheduler {
    ...
    @ManyToOne
    @JoinColumn(name = "power_playlist_id", referencedColumnName = "id", nullable = false)
    private PowerPlaylist powerPlaylist;
